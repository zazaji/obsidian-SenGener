...
var SenGenerSettingsTab = class extends import_obsidian4.PluginSettingTab {
    ...
    display() {
        ...
        containerEl.empty();
        new import_obsidian4.Setting(containerEl).setName("API Address").setDesc("The service address for generating sentenses.\r\n The default address is supported by huggingface, I didn't get the authorization . You can build a API service like :   \n\
        Post Json: { \"context\": words,  \"number\": 3 }\r\n   \
        response Json: {\"sentenses\":[{ \"value\": res1},{ \"value\": res2},{ \"value\": res3}]}\n\
